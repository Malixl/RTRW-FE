  ...
  items: [
    {
      ...
      description:
        'Mengatur pemanfaatan ruang agar sesuai dengan potensi dan daya dukung lingkungan.',
    },
    {
      id: 2,
      title: 'Keterpaduan Pembangunan',
      description:
        'Mewujudkan keterpaduan pembangunan antar sektor dan antar wilayah.',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description:
        'Mencegah konflik tata ruang, seperti tumpang tindih antara permukiman, industri, pertanian, dan kawasan lindung.',
    },
  ],
};
  ...
  items: [
    {
      ...
      description:
        'Susunan pusat-pusat kegiatan dan jaringan prasarana (jalan, pelabuhan, bandara, dsb).',
      icon: '🏗️',
    },
    {
      id: 2,
      title: 'Pola Ruang',
      description:
        'Peruntukan ruang, seperti kawasan lindung, kawasan budidaya, permukiman, industri, pertanian, dan sebagainya.',
      icon: '🗺️',
    },
    {
      id: 3,
      ...
      description:
        'Pedoman untuk penggunaan ruang yang sesuai dengan rencana.',
      icon: '📋',
    },
    {
      id: 4,
      ...
      description:
        'Ketentuan untuk mencegah pelanggaran (misal: izin lokasi, zonasi, sanksi).',
      icon: '⚖️',
    },
  ],
};
...
export const heroData = {
  ...
  description:
    'Dokumen perencanaan tata ruang yang mengatur pemanfaatan ruang di Provinsi Gorontalo dalam jangka waktu 20 tahun.',
};
